...
/**
 * The role of the action creators is to distribute an action.
 * if this action corresponds to an action of the reducer
 * the reducer changes the state of the app
 */
...
/**
 * - movie ==> is a current selected movie
 * - favoris ==> the state of favoris array
 */
